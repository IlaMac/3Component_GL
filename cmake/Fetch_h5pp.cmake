...
find_package(h5pp 1.6.0 HINTS ${CMAKE_INSTALL_PREFIX} ${CONDA_HINTS} PATHS ${CMAKE_INSTALL_PREFIX}   PATH_SUFFIXES h5pp)
...
elseif(DOWNLOAD_METHOD MATCHES "native")
    ...
    list(APPEND H5PP_CMAKE_OPTIONS  -DH5PP_DOWNLOAD_METHOD:BOOL=${DOWNLOAD_METHOD})
    list(APPEND H5PP_CMAKE_OPTIONS  -DH5PP_PREFER_CONDA_LIBS:BOOL=${PREFER_CONDA_LIBS})
    list(APPEND H5PP_CMAKE_OPTIONS  "-Dhdf5_DIR:PATH=$ENV{CONDA_PREFIX};$ENV{HOME}/anaconda3;$ENV{HOME}/miniconda3;$ENV{HOME}/miniconda")
    build_dependency(h5pp "${CMAKE_INSTALL_PREFIX}" "${H5PP_CMAKE_OPTIONS}")

    find_package(h5pp 1.6.0 HINTS ${CMAKE_INSTALL_PREFIX} PATHS PATH_SUFFIXES h5pp)
    if(h5pp_FOUND AND TARGET h5pp::h5pp)
